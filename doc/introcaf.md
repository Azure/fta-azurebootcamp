...
1. [Cloud Adoption Framework Overview](https://docs.microsoft.com/en-us/azure/cloud-adoption-framework/overview)
...
2. [Strategy](https://docs.microsoft.com/en-us/azure/cloud-adoption-framework/strategy/)  
